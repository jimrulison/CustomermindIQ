...
# Configuration
BACKEND_URL = os.getenv("REACT_APP_BACKEND_URL", "https://subscription-tiers-4.preview.emergentagent.com")
...
class FrontendBackendConnectionTester:
    ...
    async def test_cors_headers(self):
        ...
        frontend_domain = "https://subscription-tiers-4.preview.emergentagent.com"
