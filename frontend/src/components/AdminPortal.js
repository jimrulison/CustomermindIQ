                      ...
                      <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-slate-300 mb-2">Status</label>
                            <select
                              defaultValue={editingItem?.is_active ? 'active' : 'paused'}
                              className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-blue-500"
                              id="workflowStatus"
                            >
                              <option value="active">Active</option>
                        ...
                        <div>
                          <label className="block text-sm font-medium text-slate-300 mb-2">Actions Configuration</label>
                          <div className="bg-slate-700/50 rounded-lg p-4">
                            <div className="space-y-3">
                              <div className="flex items-center space-x-3">
                                <input type="checkbox" id="actionEmail" className="rounded" defaultChecked />
                                <label htmlFor="actionEmail" className="text-sm text-slate-300">Send Email</label>
                              </div>
                              <div className="flex items-center space-x-3">
                                <input type="checkbox" id="actionTag" className="rounded" />
                                <label htmlFor="actionTag" className="text-sm text-slate-300">Add User Tag</label>
                              </div>
                              <div className="flex items-center space-x-3">
                                <input type="checkbox" id="actionNotify" className="rounded" />
                                <label htmlFor="actionNotify" className="text-sm text-slate-300">Send Admin Notification</label>
                              </div>
                              <div className="flex items-center space-x-3">
                                <input type="checkbox" id="actionWebhook" className="rounded" />
                                <label htmlFor="actionWebhook" className="text-sm text-slate-300">Trigger Webhook</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            min="0"
                            defaultValue={editingItem?.delay_minutes || 0}
                            placeholder="0"
                            className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-blue-500"
                            id="workflowDelay"
                          />
                      ...
                      <div className="flex justify-end space-x-3 pt-4">
                        ...
                        <button
                          onClick={() => {
                            ...
                            const delay = document.getElementById('workflowDelay').value;
                            
                            if (name && trigger) {
                              alert(`Workflow "${name}" ${modalType === 'create-workflow' ? 'created' : 'updated'} successfully!`);
                              setShowModal(false);
                              setModalType('');
                              setEditingItem(null);
                            } else {
