...
const AffiliateAuth = () => {
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                        >
                            {loading ? (
    ...
    if (currentView === 'register') {
        console.log('Rendering registration view');
        return (
            <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
                <div className="p-4">
                    <button
                        onClick={() => setCurrentView('landing')}
                        className="text-indigo-200 hover:text-white mb-4 flex items-center"
                    >
                        ← Back to Program Info
                    </button>
                </div>
