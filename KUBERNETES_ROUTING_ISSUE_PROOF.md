...
❌ GET https://customer-insights-12.preview.emergentagent.com/api/admin/banners 
   → {"detail":"Could not validate credentials"}
❌ GET https://customer-insights-12.preview.emergentagent.com/api/admin/discounts
   → {"detail":"Could not validate credentials"}  
❌ GET https://customer-insights-12.preview.emergentagent.com/api/auth/login
   → 404 page not found
❌ GET https://customer-insights-12.preview.emergentagent.com/api/health
   → 404 page not found
```
...
- ✅ Frontend routes: `https://customer-insights-12.preview.emergentagent.com/` → port 3000 ✓
- ❌ API routes: `https://customer-insights-12.preview.emergentagent.com/api/*` → NOT reaching port 8001 ✗

## **EXPECTED KUBERNETES ROUTING**
- ✅ Frontend routes: `https://customer-insights-12.preview.emergentagent.com/` → port 3000
- ✅ API routes: `https://customer-insights-12.preview.emergentagent.com/api/*` → port 8001
...
`https://customer-insights-12.preview.emergentagent.com/api/*` → `backend:8001`
